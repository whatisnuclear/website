  ...
  <div class="accordion-item">
    <h2 class="accordion-header card-header" id="headingThree">
      <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
        <span class="fas fa-star fa-lg text-primary px-2"></span> Extreme energy density leads to miniscule pollution and mineral needs
      </button>
    </h2>
...
<p class="caption">Energy densities of various energy sources in MJ/kg and
    ...
    <div id="collapseOne" class="accordion-collapse collapse " aria-labelledby="headingOne">
      <div class="accordion-body">
        ...
        <figure>
            ...
            <figcaption>
              Source: <a href="https://www.ipcc.ch/site/assets/uploads/2018/02/ipcc_wg3_ar5_annex-iii.pdf">Schlomer S.,
              ...
              of the IPCC</a>. (<a href="/img/lifecycle-carbon-emissions-nolabel.png">Unlabeled version here</a>)
            </figcaption>
        </figure>
      </div>
    </div>
  ...
  <div class="accordion-item">
    <h2 class="accordion-header card-header" id="headingTwo">
      <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
        <span class=" fas fa-cloud-moon-rain fa-lg text-warning px-2"></span> Nuclear reactors can make energy on demand as needed
      </button>
    </h2>
...
We have a detailed page dedicated to <a href="{% link waste.md %}" class="card-link">nuclear waste here.</a>
  ...
  <div class="accordion-item">
    <h2 class="accordion-header card-header" id="headingWTwo">
      <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseWTwo" aria-expanded="false" aria-controls="collapseWTwo">
...
And advanced designs can make them even safer.
  ...
  <div class="accordion-item">
    <h2 class="accordion-header card-header" id="headingWThree">
      <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseWThree" aria-expanded="false" aria-controls="collapseWThree">
...
<p class="text-center">
<a class="btn btn-info" href="{% link economics.md %}" role="button"> <i class="fa fa-balance-scale fa-lg"></i>Read more about economics</a>
</p>
</div>
</div>
</div>
...
2014: Mitigation of Climate Change. Contribution of Working Group III to the 5th Assessment Report
of the IPCC</a>)</li>
<li><a href="https://www.oecd-nea.org/ndd/reports/2011/load-following-npp.pdf">Technical and Economic Aspects of Load Following with Nuclear Power Plants (OECD-NEA 2011)</a></li>
</ol>
